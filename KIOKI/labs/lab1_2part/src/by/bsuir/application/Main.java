...
public class Main {
    ...
    public static void main(String[] args) {
            ...
            String encryptedMessage = monoalphabeticSimple.encryption(message, 33, 'а', 'я');
            System.out.println("Encrypted message : " + encryptedMessage);
            String decryptedMessage = monoalphabeticSimple.decryption(encryptedMessage, 33, 'а', 'я');
            ...
            encryptedMessage = monoalphabeticSimple.encryption(ENGLISH_ALPHABET, 3, 'a', 'z');
            System.out.println("Encrypted message : " + encryptedMessage);
            decryptedMessage = monoalphabeticSimple.decryption(encryptedMessage, 3, 'a', 'z');
            System.out.println("Decrypted message: " + decryptedMessage);
            ...
            encryptedMessage = new MonoalphabeticComplex().encryption(ENGLISH_ALPHABET, 7, 'a', 'z');
            System.out.println("Encrypted message : " + encryptedMessage);
            decryptedMessage = new MonoalphabeticComplex().decryption(encryptedMessage, 15, 'a', 'z');
            System.out.println("Decrypted message: " + decryptedMessage);
            response = ENGLISH_ALPHABET.equals(decryptedMessage) ? "Initial message equals decrypted" : "Error! Initial message NOT equals decrypted";
            System.out.println(response);
        }
